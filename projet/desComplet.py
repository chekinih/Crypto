...
# Chiffrer un bloc plaintext (chaine de caractere de 64 bits) avec la cle k(chaine de caractere de 64 bits)
...
# Dechiffrer un bloc ciphertext de taille 64 bits (resultat du chiffrement de plaintext) avec la cle k
