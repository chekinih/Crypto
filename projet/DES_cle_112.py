...
# Separer la cle en entree de taille 112 bits en 2 cles k1 et k2 de taille 64 bits
...
# Cette fonction renvoie le chiffrement du text en parametre avec une cle de taille 112 bits, en suivant des etapes precises
def chiffrement_DES_112(text,key):
    ...
    if (type(text) != str) :
        ...
        print(" Erreur: La clé doit être une chaine de 14 caractères (112 bits) !")
        return -1
    else:
...
# Cette fonction renvoie le dechiffrement du text en parametre avec une cle de taille 112 bits, en suivant des etapes precises
def dechiffrement_DES_112(ciphertext,key):
    
    key_to_binary = desComplet.text_to_bits(key)
    # Separer la cle de 112 bits : 2 clés k1 et k2 de 56bits
    k1, k2 = separate_in_2_keys_64(key_to_binary)
