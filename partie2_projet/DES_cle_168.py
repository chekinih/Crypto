...
def chiffrement_DES_168(text,key):
    ...
    if (type(text) != str) :
        ...
        print("La clé doit être une chaine de 21 caractères (168 bits) !")
        return -1
    else:
        #print('PlainText avant le chiffrement: '+text)
...
#def main(text, key):
#    
#        # les etapes pour le chiffrement DES avec une cle de 168 bits
#        #1. Chiffrer avec k1
#        #2. Déchiffrer avec k2
#        #3. Chiffrer avec k3
#        
#        cipherText = chiffrement_DES_168(text,key)
#        
#        if cipherText != -1 :
#            plaintext = dechiffrement_DES_168(cipherText,key)
#
#            print(plaintext)
#
#
#res = main('coucou tout le monde', '<64RERDRC65CFjhjhjhj')